...
@Component({
  ...
  selector: 'locations-search-component',
  template: ` 
  <div class="slide-header">
        <h3>Search</h3>
        <button mat-icon-button (click)="locations.searchFlag = false">
    ...
    <div class="slide-footer">
        <button mat-button (click)="locations.searchFlag = false">Close</button>
...
export class SearchLocations {
  ...
  constructor(public locations: LocationsComponent) {}
