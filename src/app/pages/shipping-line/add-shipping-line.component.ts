...
export class AddShippingLineComponent {
  ...
  constructor(public gl: GlobalVariable, private master: MasterCallService, private _snackBar: MatSnackBar,
    private srv: ShippingLineService, private nav: Router, private fleetApi: FleetAPIService, 
  ) {  }
  ...
  getCountries() {
    console.log("get countries", this.gl.setRowData);
      ...
      self.master.getAllCountries().subscribe((m) => {
        if (m.respStatus) {
          ...
          if(this.gl.setRowData) {
            this.countryInit({value: this.gl.setRowData.shippingLineAddresses[0].address.countryId});
          }
        } 
      });
  }
  ...
  countryInit(event:any) {
    ...
    self.master.getStateWithCountry(event.value).subscribe((m:any) => {
      if (m.respStatus) {
        ...
        if(this.gl.setRowData) {
          this.stateChange({value:this.gl.setRowData.shippingLineAddresses[0].address.stateId});
        }
      }
    });
  }
  ...
  countryChange(event:any) {
    ...
    self.master.getStateWithCountry(event.value).subscribe((m:any) => {
      if (m.respStatus) {
        this.states = m.lstModel;
        // if(this.gl.setRowData) {
        //   this.stateChange({value:this.gl.setRowData.shippingLineAddresses[0].address.cityId});
        // }
      }
    });
  }
  ...
  stateChange(event:any) {
    ...
    self.master.getCityWithState(event.value).subscribe((m:any) => {
      if (m.respStatus) {
        this.cities = m.lstModel;
        //   if(this.gl.setRowData) {
        //   this.stateChange(this.gl.setRowData.shippingLineAddresses);
        // }
  ...
  Form = new FormGroup({
    ...
    shippingLineAddresses: new FormControl([])
  }) as any;

  shippingLineAddresses = new FormGroup({
  ...
  setValue(data:any) {
    ...
    // this.Form.controls["addressId"].setValue(data.shippingLineAddresses[0].addressId);
    ...
    this.Form.controls["scacCode"].setValue('');
    // this.Form.controls["shippingLineAddresses"].setValue(data?.shippingLineAddresses);

    this.shippingLineAddresses.controls["shippingId"].setValue(data.shippingLineAddresses[0].shippingId);
    this.shippingLineAddresses.controls["addressId"].setValue(data.shippingLineAddresses[0].addressId);
    // this.Form.controls["address"].setValue(data.address);

    this.address.controls["addressId"].setValue(data.shippingLineAddresses[0].address.addressId);
    this.address.controls["addressGuid"].setValue(data.shippingLineAddresses[0].address.addressGuid);
    this.address.controls["addressTitle"].setValue(data.shippingLineAddresses[0].address.addressTitle);
    this.address.controls["streetLine1"].setValue(data.shippingLineAddresses[0].address.streetLine1);
    this.address.controls["streetLine2"].setValue(data.shippingLineAddresses[0].address.streetLine2);
    this.address.controls["cityId"].setValue(data.shippingLineAddresses[0].address.cityId);
    this.address.controls["cityName"].setValue(data.shippingLineAddresses[0].address.cityName);
    this.address.controls["stateId"].setValue(data.shippingLineAddresses[0].address.stateId);
    this.address.controls["stateName"].setValue(data.shippingLineAddresses[0].address.stateName);
    this.address.controls["postalCode"].setValue(data.shippingLineAddresses[0].address.postalCode);
    this.address.controls["countryId"].setValue(data.shippingLineAddresses[0].address.countryId);
    this.address.controls["countryName"].setValue(data.shippingLineAddresses[0].address.countryName);
    this.address.controls["companyId"].setValue(data.shippingLineAddresses[0].address.companyId);
    this.address.controls["rateZoneId"].setValue(data.shippingLineAddresses[0].address.rateZoneId);
    this.address.controls["latitude"].setValue(data.shippingLineAddresses[0].address.latitude);
    this.address.controls["longitude"].setValue(data.shippingLineAddresses[0].address.longitude);
    this.address.controls["utcCreatedAt"].setValue(data.shippingLineAddresses[0].address.utcCreatedAt);
    this.address.controls["createdBy"].setValue(data.shippingLineAddresses[0].address.createdBy);
    this.address.controls["utcModifiedAt"].setValue(data.shippingLineAddresses[0].address.utcModifiedAt);
    this.address.controls["modifiedBy"].setValue(data.shippingLineAddresses[0].address.modifiedBy);
    this.address.controls["isActive"].setValue(data.shippingLineAddresses[0].address.isActive);
    this.address.controls["timeZoneId"].setValue(data.shippingLineAddresses[0].address.timeZoneId);
    // this.Form.controls["addressTypes"].setValue(data.addressTypes);
    // this.Form.controls["contactPerson"].setValue(data.contactPerson);
    this.addressTypes.controls["addressId"].setValue(data.shippingLineAddresses[0].address.addressTypes[0].addressId);
    this.addressTypes.controls["addressTypeId"].setValue(data.shippingLineAddresses[0].address.addressTypes[0].addressTypeId);
   
    this.contactPerson.controls["contactPersonId"].setValue(data.shippingLineAddresses[0].address.contactPerson[0].contactPersonId);
    this.contactPerson.controls["addressId"].setValue(data.shippingLineAddresses[0].address.contactPerson[0].addressId);
    this.contactPerson.controls["name"].setValue(data.shippingLineAddresses[0].address.contactPerson[0].name);
    this.contactPerson.controls["phone"].setValue(data.shippingLineAddresses[0].address.contactPerson[0].phone);
    this.contactPerson.controls["fax"].setValue(data.shippingLineAddresses[0].address.contactPerson[0].fax);
    // this.contactPerson.controls["emailMapping"].setValue(data.shippingLineAddresses[0].address.contactPerson[0].emailMapping);

    this.emailMapping.controls["contactPersonId"].setValue(data.shippingLineAddresses[0].address.contactPerson[0].emailMapping[0].contactPersonId);
    this.emailMapping.controls["addressId"].setValue(data.shippingLineAddresses[0].address.contactPerson[0].emailMapping[0].addressId);
    this.emailMapping.controls["emailTypeId"].setValue(data.shippingLineAddresses[0].address.contactPerson[0].emailMapping[0].emailTypeId);
    this.emailMapping.controls["email"].setValue(data.shippingLineAddresses[0].address.contactPerson[0].emailMapping[0].email);
  }
  ...
  save() {
    ...
    // data.shippingLineAddresses.push(this.shippingLineAddresses.value);
    // data.shippingLineAddresses[0].address = this.address.value;
    // data.shippingLineAddresses[0].address.addressTypes.push(this.addressTypes.value);
    // data.shippingLineAddresses[0].address.contactPerson.push(this.contactPerson.value);
    // data.shippingLineAddresses[0].address.emailMapping.push(this.emailMapping.value);

    data.shippingLineAddresses.push(this.shippingLineAddresses.value);
    data.shippingLineAddresses[0].address = this.address.value;
    data.shippingLineAddresses[0].address.addressTypes.push(this.addressTypes.value);
    data.shippingLineAddresses[0].address.contactPerson.push(this.contactPerson.value);
    data.shippingLineAddresses[0].address.contactPerson[0].emailMapping.push(this.emailMapping.value);
    ...
    if (this.Form.valid) {
      ...
      if (this.gl.setRowData) {
        self.srv.update(data).subscribe((m:any) => {
          if (m.success) {
            this.nav.navigateByUrl('/shipping-line');
        ...
        self.srv.AddShippingLine(data).subscribe((m:any) => {
          if (m.success) {
            this.nav.navigateByUrl('/shipping-line');
      ...
      for (let i in this.shippingLineAddresses.controls) {
        this.shippingLineAddresses.controls[i].markAsTouched();
      }
