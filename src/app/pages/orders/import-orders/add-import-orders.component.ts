...
@Component({
  ...
  // providers: [ImportOrdersComponent],
  template: `
        ...
        <div class="row">
                      ...
                      <div class="col-3">
                        <div class="row">
                          <div class="col-6">
                            <div class="input-wrap">
                              <label class="form-label">
                                <mat-checkbox>Week Days</mat-checkbox></label
                              >
                              <mat-form-field appearance="outline">
                          ...
                          <div class="col-6">
                            <div class="input-wrap">
                              <label class="form-label"
                                ><mat-checkbox>24 Hours</mat-checkbox></label
                              >
                              <mat-form-field appearance="outline">
          ...
          <div class="col-3">
            <div class="row">
              ...
              <div class="col-12">
                <div class="input-wrap flex-input-bx">
                  <label class="form-label flex-input-bx">Leg Type</label>
                  <mat-form-field appearance="outline">
                    <mat-select formControlName="legType">
                      @for(legType of legTypesList; track legType.legTypeId) {
                      <mat-option [value]="legType.legTypeId">{{
                        legType.legTypeName
                      }}</mat-option>
                      }
                    </mat-select>
                    ...
                    <div class="input-wrap flex-input-bx">
                      ...
                      <mat-form-field appearance="outline">
                        <mat-select formControlName="currencyType">
                          @for(currency of currencyList; track
                          currency.currencyId) {
          ...
          <div class="hr-light"></div>
              ...
              <div class="input-wrap flex-input-bx">
                ...
                <mat-form-field appearance="outline">
                  <mat-select formControlName="shippingLineId" (selectionChange)="changeShippingLine($event)">
                    @for(shippingLine of shippingLineList; track
                    shippingLine.id) {
                    <mat-option [value]="shippingLine.id">{{
                      shippingLine.name
                    }}</mat-option>
                    }
                  </mat-select>
            ...
            <div class="col-12">
                    ...
                    <div class="col-12">
                  <mat-slide-toggle formControlName="highPriority"
                    >High Priority</mat-slide-toggle>
                </div>
            </div>
            </div>
          </div>
...
export class AddImportOrdersComponent {
  ...
  currencyList: any;
  legTypesList: any;
  newlyAddedOrder: any = true;
  newGuid: string = '';
  branchList: any;

  constructor(
    public list: ImportOrdersComponent,
    private srv: OrdersService,
    private customer: CustomerService,
    private shippingLine: ShippingLineService,
    private master: MasterCallService,
    private fleetApi: FleetAPIService,
    public gl: GlobalVariable,
  ...
  getOrderById() {
    let self = this;
    self.srv.getOrderById(this.gl.selectedOrder.orderId).subscribe((m: any) => {
      if (m.success) {
        console.log("🚀 ~ AddImportOrdersComponent ~ self.srv.getOrderById ~ m:", m)
  ...
  goToOrderdetailPage() {
    this.nav.navigateByUrl('/import-orders/details/' + this.newGuid);
  }
