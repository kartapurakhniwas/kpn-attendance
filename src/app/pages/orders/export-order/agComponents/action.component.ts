...
@Component({
  ...
  imports: [CommonModule,
    ...
    providers: [ExportOrdersComponent],
...
export class ActionMenu implements ICellRendererAngularComp {
  ...
  constructor(public order: ExportOrdersComponent, private gl: GlobalVariable, private nav: Router) {}
...
//   }
  ...
  viewDetails() {
    ...
    this.nav.navigateByUrl('/export-orders/details/' + this.value.data.orderGuid);
  }
