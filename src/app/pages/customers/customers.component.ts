...
export class CustomersComponent {
  ...
  constructor(public gl: GlobalVariable, private _srv: CustomerService) {
    ...
    this.columnDefs = [
      ...
      { field: 'name', headerName: 'Customer Name', width: 110,  },
      { 
        field: 'address', 
        headerName: 'Address', 
        width: 240, 
        valueGetter: (params:any) => {
          let a = params.data.customerAddresses[0].address.streetLine1 +', '+ params.data.customerAddresses[0].address.cityName +', '+ params.data.customerAddresses[0].address.stateName +', '+ params.data.customerAddresses[0].address.countryName +', '+ params.data.customerAddresses[0].address.postalCode;
          return a;
        },
      },
      { 
        ...
        headerName: 'Email', 
        width: 140, 
        valueGetter: (params:any) => params.data.customerAddresses[0].address.contactPerson[0].emailMapping[0].email,
      },
      { 
        field: 'phone', 
        headerName: 'Phone', 
        width: 140, 
        valueGetter: (params:any) => params.data.customerAddresses[0].address.contactPerson[0].phone,
      },
      { 
        field: 'fax', 
        headerName: 'fax', 
        width: 140, 
        valueGetter: (params:any) => params.data.customerAddresses[0].address.contactPerson[0].fax,
      },
      { 
        field: 'url', 
        headerName: 'URL', 
  ...
  refresh() {
    this._srv.getAllCustomers(7).subscribe({
      next: (response: any) => {
