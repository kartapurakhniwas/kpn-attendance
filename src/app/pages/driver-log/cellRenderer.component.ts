...
@Component({
  ...
  template: ` 
    ...
    <mat-menu #menu="matMenu" xPosition="after" class="list-pb-0">
      <button mat-menu-item (click)="driverLog.backToYard = true">Back To Yard</button>
      <button mat-menu-item (click)="driverLog.doneForDay = true">End Day</button>
      <button mat-menu-item >Delete Log</button>
      <button mat-menu-item >Add Shift</button>
    </mat-menu>
  `,
})
